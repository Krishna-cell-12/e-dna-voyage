...
import { Dna, Zap, Eye, Database, Brain, Waves } from 'lucide-react';
...
const Index = () => {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-montserrat font-bold mb-8">
            <span className="bioluminescent-text">eDeepSea</span>
          </h1>
      ...
      {/* Footer */}
      <footer className="relative py-12 border-t border-border/20 z-10">
        <div className="container mx-auto px-6 text-center">
          <h3 className="text-2xl font-montserrat font-bold bioluminescent-text mb-4">
            eDeepSea
          </h3>
          <p className="text-muted-foreground mb-6">
            Illuminating the mysteries of the deep through AI-driven discovery
          </p>
          ...
          <div className="mt-6 pt-6 border-t border-border/20 text-sm text-muted-foreground">
            © 2024 eDeepSea Research Initiative. Exploring the unknown depths of our oceans.
          </div>
        </div>
      </footer>
    </div>
